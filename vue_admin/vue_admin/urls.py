...
urlpatterns = [
    ...
    # 非Rest风格接口
    # 登录接口
    path('api/user/login/',user_view.loginHttpMethods),
    path('api/user/register/',user_view.registerHttpMethods),
    path('api/user/logout/',user_view.logoutHttpMethods),
    path('api/user/info/',user_view.getUserInfoHttpMethods),
